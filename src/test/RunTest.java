    ...
    */
        ...
        */
        ...
        try {
            ...
            log.info("Initialize the security context for the rOCCI JSAGA adaptor");
            session = SessionFactory.createSession(false);
            ...
            // Set ...
            context.setAttribute("UserProxyObject","AABBCCDDEEFF00112233445566778899");
            //context.setAttribute(Context.STRING, "brunor");            
        ...
        //OCCI_ENDPOINT_HOST = "rocci://carach5.ics.muni.cz";
	...
	//os_tpl#uuid_gwdg_ubuntu_14_04_56
        ...
        //OCCI_ENDPOINT_HOST = "rocci://stack-server-01.cloud.dfa.unict.it";
        //OCCI_ENDPOINT_PORT = "8787";        
        // Possible OCCI_OS values: 'generic_vm', 'octave' and 'r'
	...
	// os_tpl#978edc01-b944-4b05-b096-6fc951161a1d ==> r
        ...
        //OCCI_ENDPOINT_HOST = "rocci://nebula-server-01.ct.infn.it";
        //OCCI_ENDPOINT_PORT = "9000";
        // Possible OCCI_OS values: 'generic_vm', 'octave' and 'r'
	...
	// 91632086-39ef-4e52-a6d1-0e4f1bf95a7b ==> r        
        ...
        //OCCI_ENDPOINT_HOST = "rocci://prisma-cloud.ba.infn.it";
        //OCCI_ENDPOINT_PORT = "8787";
        ...
        //OCCI_OS = "56c11ccb-c696-4fe6-b061-b5df24913580";
        //OCCI_FLAVOR = "small";
        
        // === OCCI SETTINGS for the IHEP (OpenStack) CLOUD RESOURCE === //
        //OCCI_ENDPOINT_HOST = "rocci://sched02.ihep.ac.cn";
        //OCCI_ENDPOINT_PORT = "8787";
        ...
        //OCCI_ENDPOINT_HOST = "rocci://rocci.grid.arn.dz";
        //OCCI_ENDPOINT_PORT = "11443";
        // Possible OCCI_OS values: 'generic_vm', 'octave' and 'r'        
	...
	// os_tpl#uuid_virt_r_33 ==> r                
        ...
        //OCCI_OS = "uuid_generic_www_31";
        //OCCI_FLAVOR = "small";
        
        // === OCCI SETTINGS for the CIEMAT (OpenNebula) CLOUD RESOURCE === //
        //OCCI_ENDPOINT_HOST = "rocci://one01.ciemat.es";
        //OCCI_ENDPOINT_PORT = "11443";
        // Possible OCCI_OS values: 'generic_vm', 'octave' and 'r'
	...
	// os_tpl#uuid_chain_reds_r_27 ==> r     
        ...
        // Possible ACTION valu es: 'list', 'describe', 'create' and 'delete'
        //OCCI_ACTION = "create";  
        /*
        try {    
            log.info("");
